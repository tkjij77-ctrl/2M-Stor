...
--  ⚠️ اقرأ هذا أولًا (T3.7 — 21 سبتمبر 2026)
--  هذا الملف هو **طبقة الأساس فقط** (7 جداول · 19 سياسة · Storage).
--  نظام اليوم يحتاج ما بعده: الحذف الناعم · نموذج المخزون · دوال الخصم الذرّية ·
--  ترقيم الفواتير المركزي · فهارس البحث العربي · تفعيل Realtime.
--  ولذلك:
--     1) نفّذ هذا الملف (أو ترحيل الأساس نفسه)
--     2) ثم نفّذ ملفات supabase/migrations/*.sql **بالترتيب الزمني** — الأحدث يفوز
--     3) تحقّق: node scripts/verify-schema-drift.js   (فحص ذاتي بلا إنترنت)
--        ثم:   node scripts/verify-schema-drift.js inventory.txt  (مقارنة مع القاعدة الحقيقية)
--
--  المرجع الحقيقي الوحيد هو supabase/migrations/ — وهذا الملف نسخة أولى مطابقة له،
--  وverify-schema-drift.js يفشل إن تباعدا.
-- ═══════════════════════════════════════════════════════════════════
